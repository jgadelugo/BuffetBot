...
class Cache:
    ...
    def get(self, key: str, expiration: Optional[int] = None) -> Optional[Any]:
        """
    ...
    def set(self, key: str, data: Any, expiration: Optional[int] = None) -> bool:
        """
        Store data in cache.
            ...
            if self.cache_type == "memory":
                ...
                for cache_file in self.cache_dir.glob("*.cache"):
                    ...
                    with open(cache_file, "rb") as f:
                        cache_data = pickle.load(f)
                        if self._is_expired(cache_data["timestamp"], cache_data["expiration"]):
                            stats["expired"] += 1
...
def cache_result(expiration: Optional[int] = None):
    """
