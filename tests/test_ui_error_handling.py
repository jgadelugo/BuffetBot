...
def test_edge_cases():
    ...
    print(f"    price_change: {safe_get_nested_value(complex_data, 'data', 'metrics', 'price_change')}")
    print(f"    volatility: {safe_get_nested_value(complex_data, 'data', 'metrics', 'volatility')}")
