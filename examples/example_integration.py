...
def enhanced_analysis_output(analysis_results: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    enhanced = {"results": analysis_results, "metrics_info": {}, "interpretations": {}}
                ...
                try:
                    ...
                    if ratio_key == "current_ratio":
                        ...
                        if ratio_value < 0.5:
                            ...
                            interpretation = (
                                "Very high leverage - significant financial risk"
                            )
                        enhanced["interpretations"][ratio_key] = interpretation
            ...
            if metric_info["category"] == category:
                ...
                if value is not None:
                    ...
                    if isinstance(value, (int, float)):
                        if metric_key.endswith("_ratio") or metric_key.endswith(
                            "_margin"
                        ):
                            report += f" {value:.2f}"
                        elif metric_key.endswith("_growth") or metric_key.endswith(
                            "_cagr"
                        ):
                            report += f" {value:.1%}"
                        else:
...
if __name__ == "__main__":
    ...
    sample_results = {
        ...
        "value_metrics": {"pe_ratio": 18.5, "pb_ratio": 3.2},
    }
